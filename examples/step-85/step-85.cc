...
//     R); VectorTools::interpolate(level_set_dof_handler,
//                              signed_distance_sphere,
//                              level_set);
//     // ImplicitFunction implicit_function;
...
//   {
//     (void)component;
//     return 8. * numbers::PI * numbers::PI * std::sin(2. * numbers::PI *
//     p[0]);
...
//     const double ghost_parameter   = 0.5;
//     const double nitsche_parameter = 5 * (fe_degree + 1) * fe_degree; // 1e5
...
//     const unsigned int max_iterations = 1e5; //;solution.size();
...
// //     // return 1. - 2. / dim * (point.norm_square() - 1.);
// //     return 8. * M_PI * M_PI * std::sin(2. * M_PI * p[0]) *
// //            std::sin(2. * M_PI * p[1]);
// //   }
...
// //     GridGenerator::hyper_cube(triangulation, -0.8, 0.8);
...
// //       //        .5 - 0.2 * std::sin(w * std::atan2(p[1] - yc, p[0] - xc));
// //       // return std::pow(p[0] * p[0] + p[1] * p[1], 2) -
// //       //        .1 * std::pow(std::cos(6. * M_PI * std::atan2(p[1],
// p[0])),
// //       2) -
// //       //        .5;
// //     }
...
// //     const Functions::SignedDistance::Sphere<dim>
// signed_distance_sphere({},
// // 0.5);
// //     VectorTools::interpolate(level_set_dof_handler,
// //                              signed_distance_sphere,
...
// //     dof_handler.distribute_dofs(fe_collection);
// //     std::cout << "N DoFs: " << dof_handler.n_dofs() << std::endl;
// //   }
...
// //     Table<2, DoFTools::Coupling> cell_coupling(n_components,
// n_components);
// //     Table<2, DoFTools::Coupling> face_coupling(n_components,
// n_components);
// //     cell_coupling[0][0] = DoFTools::always;
// //     face_coupling[0][0] = DoFTools::always;
...
// //     const RhsFunction<dim>       rhs_function;
// //     const BoundaryCondition<dim> boundary_condition;
...
// //                 {
// //                   const Tensor<1, dim> normal =
// //                   fe_interface_values.normal(q); for (unsigned int i = 0;
// i <
// //                   n_interface_dofs; ++i)
...
// //     DataOut<dim> data_out;
// //     data_out.add_data_vector(dof_handler, solution, "solution");
// //     data_out.add_data_vector(level_set_dof_handler, level_set,
// "level_set");
