...
// Constructu a MGCoarseGridIterativeSolver by wrapping the coarse matrix in a LinearOperator
...
LaplaceProblem<dim>::solve()
{
  ...
  const auto &coarse_operator = linear_operator(coarse_matrix);
  ...
  MGCoarseGridIterativeSolver<vector_t,
                              SolverCG<vector_t>,
                              LinearOperator<vector_t>,
                              PreconditionIdentity>
    coarse_grid_solver(coarse_solver, coarse_operator, id); 
